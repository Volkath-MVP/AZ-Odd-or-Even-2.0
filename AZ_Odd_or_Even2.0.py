...
def sounds_exed_choice(sound_exed):
    ...
    if sound_exed == exed_sounds:
        #sound
        exed_sound_path = os.path.join(base_path, "Sonds_Efects", "exed.mp3")
        return exed_sound_path
    if sound_exed == max_exed_sounds:
        #sound
        exed_sound_path = os.path.join(base_path, "Sonds_Efects", "max_exed.mp3")
        return exed_sound_path
#buttons sounds
def sounds_choice(sound_efx):
    if sound_efx == "":
        ...
        #sound
        sound_path = os.path.join(base_path, "Sonds_Efects", "menu_button_sound.mp3")
        return sound_path
    elif sound_efx == back_buttons_sounds:
        #sound
        sound_path = os.path.join(base_path, "Sonds_Efects", "whoosh_efects.mp3")
        return sound_path
def sound_play():
...
def musics_choice(sound_music_announcer):
    if sound_music_announcer == "":
        ...
        #sound
        sound_announcer_path = os.path.join(base_path, "Sonds_Efects", "rank_sounds_D.mp3")
        return sound_announcer_path
    elif sound_music_announcer == RankC_sounds:
        #sound
        sound_announcer_path = os.path.join(base_path, "Sonds_Efects", "rank_sounds_C.mp3")
        return sound_announcer_path
    elif sound_music_announcer == RankB_sounds:
        #sound
        sound_announcer_path = os.path.join(base_path, "Sonds_Efects", "rank_sound_B.mp3")
        return sound_announcer_path
    elif sound_music_announcer == RankA_sounds:
        #sound
        sound_announcer_path = os.path.join(base_path, "Sonds_Efects", "rank_sounds_A.mp3")
        return sound_announcer_path
    elif sound_music_announcer == RankS_sounds:
        #sound
        sound_announcer_path = os.path.join(base_path, "Sonds_Efects", "rank_sound_S.mp3")
        return sound_announcer_path
    elif sound_music_announcer == RankSS_sounds:
        #sound
        sound_announcer_path = os.path.join(base_path, "Sonds_Efects", "rank_sound_SS.mp3")
        return sound_announcer_path
    elif sound_music_announcer == RankSSS1_sounds:
        #sound
        sound_announcer_path = os.path.join(base_path, "Sonds_Efects", "rank_sound_SSS1.mp3")
        return sound_announcer_path
    elif sound_music_announcer == RankSSS2_sounds:
        #sound
        sound_announcer_path = os.path.join(base_path, "Sonds_Efects", "rank_sound_SSS2.mp3")
        return sound_announcer_path
    elif sound_music_announcer == RankAZ_sounds:
        #sound
        sound_announcer_path = os.path.join(base_path, "Sonds_Efects", "sound_rank_AZ.mp3")
        return sound_announcer_path
def musics_play():
...
def background_theme(selected_theme):
    if selected_theme == "":
        ...
        #background
        img_path = os.path.join(base_path, "Backgrounds", "dante_4k.jpg")
        theme_select = img_path
        #Musics
        music_path = os.path.join(base_path, "Musics", "Devil_May_Cry 5_Subhuman_[EPIC METAL COVER]_(Little V).mp3")
        return theme_select, music_path
    elif selected_theme == "DMC_Dante":
        #background
        img_path = os.path.join(base_path, "Backgrounds", "Dante_DMC_Devil_May_Cry.jpg")
        theme_select = img_path
        #Musics
        music_path = os.path.join(base_path, "Musics", "sent-to-destroy-dmc-devil-may-cry.mp3")
        return theme_select, music_path
    elif selected_theme == "Vergil":
        #background
        img_path = os.path.join(base_path, "Backgrounds", "vergil_DMC5.png")
        theme_select = img_path
        #Musics
        music_path = os.path.join(base_path, "Musics", "bury_the_light.mp3")
        return theme_select, music_path
    elif selected_theme == "DMC3_Vergil":
        #background
        img_path = os.path.join(base_path, "Backgrounds", "Vergil_DMC3.jpg")
        theme_select = img_path
        #Musics
        music_path = os.path.join(base_path, "Musics", "vergil-battle-2-extended-version.mp3")
        return theme_select, music_path
    elif selected_theme == "DMC3_Dante":
        #background
        img_path = os.path.join(base_path, "Backgrounds", "Dante_DMC3.jpg")
        theme_select = img_path
        #Musics
        music_path = os.path.join(base_path, "Musics", "Devil May Cry 3 - Devils Never Cry [EPIC METAL COVER] (Little V)(MP3_128K).mp3")
        return theme_select, music_path
    elif selected_theme == "V":
        #background
        img_path = os.path.join(base_path, "Backgrounds", "V.jpg")
        theme_select = img_path
        #Musics
        music_path = os.path.join(base_path, "Musics", "Devil May Cry 5 - Crimson Cloud [EPIC METAL COVER] (Little V)(MP3_128K).mp3")
        return theme_select, music_path
    elif selected_theme == "VergilDMC4":
        #background
        img_path = os.path.join(base_path, "Backgrounds", "vergil_DMC4.jpg")
        theme_select = img_path
        #Musics
        music_path = os.path.join(base_path, "Musics", "vergils_theme_DMC4.mp3")
        return theme_select, music_path
def draw_game():
    ...
    for event in pg.event.get():#"for event in pg.event.get()""for" = makes it so that for each thing inside "event", which are the events that happen"in" inside "pg.event", Pygame events".get()"
     #to read or search inside pg.event. Pygame stores all user interactions in a list, and pg.event.get() searches for one of those already listed events—in this case, "event"
        ...
        #main menu mouse
            ...
            x, y = event.pos
            #print(game_state)
            if main_menu_fps_back_button and main_menu_fps_back_button.collidepoint((x, y)):
                game_state = main_menu_config
                sound_efx = back_buttons_sounds
                #print(game_state)
                #print(sound_efx)
        ...
        #Menu mouse
            ...
            x, y = event.pos
            #print(game_state)
            if menu_fps_back_button and menu_fps_back_button.collidepoint((x, y)):
                game_state = menu_config
                sound_efx = back_buttons_sounds
                #print(game_state)
                #print(sound_efx)
